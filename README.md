...
# Model Deployment
I deployed the model to the HuggingFace Spaces Gradio App. The implementation can be found in the `deployment` folder or [![Hugging Face Interface](https://img.shields.io/badge/hugging_face-ball_classifier-blue)](https://huggingface.co/spaces/kavinh07/ball-classifier). <br/>
